...
export default function ValidatorCTA() {
  return (
    <motion.section
      ...
      className="relative w-full overflow-hidden bg-[#f7f7f8]"
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_22%,rgba(255,255,255,0.75),rgba(255,255,255,0)_52%),linear-gradient(180deg,rgba(255,45,45,0.055)_0%,rgba(255,255,255,0.45)_45%,rgba(230,233,238,0.45)_100%)]" />
