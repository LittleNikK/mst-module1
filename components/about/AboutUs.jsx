...
{/* <!-- HEADER / LOGO --> */}
<header class="px-10 py-6 flex items-center justify-between">
  <div class="flex items-center gap-3">
    <img src="https://mstblockchain.com/images/mst-dark-logo.svg" class="h-20" />
    <div>
      <h2 class="font-bold text-red-600">MST BLOCKCHAIN</h2>
      <p class="text-xs text-gray-500">YOUR PATH TO A DECENTRALIZED FUTURE</p>
    </div>
  </div>
</header>
